...
import ComponentsFooter from '../components/organism/Footer/componentsFooter';
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-gray-100 min-h-screen py-10 px-5">
      ...
      <div className="flex justify-center gap-5 mt-8">
        <ComponentsFooter
          descricao="Whatsapp"
          imagem="./src/image/Whatsapp.png"
          href="https://www.whatsapp.com/?lang=pt_BR"
        />
        <ComponentsFooter
          descricao="Telegram"
          imagem="./src/image/Telegram.png"
          href="https://web.telegram.org/"
        />  
        <ComponentsFooter
          descricao="Email"
          imagem="./src/image/Email.png"
