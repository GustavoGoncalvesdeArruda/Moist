  ...
  return (
    <div className="relative text-center my-8">
      <input
        ...
        className="w-72 px-4 py-2 pr-10 text-base border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition" // Removido qualquer 'rounded'
